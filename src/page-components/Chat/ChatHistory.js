...
const ChatHistory = ({ handleChatHistoryClick, handleNewChat, chatHistory }) => {
        ...
        <div className='w-1/4 p-4 overflow-y-auto bg-gray-200 dark:bg-gray-700'>
            ...
            {chatHistory && (
                chatHistory.map((history) => (
                    <div key={history._id} className='mb-4 cursor-pointer' onClick={() => handleChatHistoryClick(history)}>
