const Overview = () => {
  return (
      <div
      className="bg-white p-6 shadow-[0px_4px_12px_-5px_rgba(0,0,0,0.4)] w-full max-w-sm rounded-2xl font-[sans-serif] overflow-hidden mx-auto mt-4">
      <div className="flex flex-col items-center">
        ...
        <div className="mt-4 text-center">
          <p className="text-lg text-gray-800 font-bold">John</p>
