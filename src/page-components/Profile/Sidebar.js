...
const Sidebar = () => {
  return (
    <nav class="bg-white custom-shadow h-screen top-0 left-0 min-w-[250px] py-6 px-4 font-[sans-serif] overflow-auto">
      <div class="relative flex flex-col h-full">
        <div class="flex flex-wrap items-center cursor-pointer relative">
          ...
          />
          <div class="ml-4">
            <p class="text-sm text-[#333] font-semibold">MarkHub</p>
            <p class="text-xs text-gray-400 mt-0.5">Team Plan</p>
          </div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="w-3 h-3 absolute right-0 fill-gray-400"
