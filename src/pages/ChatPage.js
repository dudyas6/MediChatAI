...
function ChatPage() {
    ...
    return (
        ...
        <div className="flex-1 overflow-y-auto p-4 bg-blue-100" style={{ marginBottom: '100px' }}>
        ...
        <div className="p-4 bg-gray-100 fixed bottom-0 w-full"> {/* Use fixed or absolute positioning with bottom-0 to ensure visibility */}
